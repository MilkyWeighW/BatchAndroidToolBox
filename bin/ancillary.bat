...
if /i "%choice%"=="1" cls & echo 将会每隔五秒检查并打印设备列表. & goto chkadb
if /i "%choice%"=="2" cls & echo 将会每隔五秒检查并打印设备列表. & goto chkfb
if /i "%choice%"=="3" call chkdev.bat system & cls & echo 将会每隔5秒检查并打印当前应用 & goto listen
...
if /i "%choice%"=="a" start https://www.123pan.com/s/on0rVv-zhhV.html & echo 已打开网页，请自行下载安装! & pause >nul & %menu%
...
if /i "%packageName%"=="NotificationShade}" ( echo 当前正在锁屏/状态栏! && %partcode% && endlocal && goto listen)
if /i "%packageName%"=="" ( echo 当前正在切换应用!  && %partcode% && endlocal && goto listen )
